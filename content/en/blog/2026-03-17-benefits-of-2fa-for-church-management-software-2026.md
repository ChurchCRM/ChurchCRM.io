...
### Built for the Small-to-Mid-Sized Congregation
...
* **The "solo IT guy":** Designed to run on a standard LAMP stack that any hobbyist can manage.

## Deep Dive: 2FA Features in ChurchCRM v7.0+

The latest 2026 releases of ChurchCRM have completely overhauled the 2FA experience, making it more secure and easier to manage than ever.
...
* **Mandate 2FA** for anyone with admin access.
...
| :--- | :--- | :--- |
| **Enable globally** | Turn on 2FA in System Settings. | Opens the capability for all users. |
| **User enrollment** | User scans a QR code via their profile page. | Ties their account to a physical device. |
| **Recovery codes** | System generates one-time backup codes. | Prevents lockouts if a phone is lost. |

## The Honest Trade-offs

At ChurchCRM, we believe in candor. Because we are a volunteer-built, self-hosted project, there are trade-offs:

* **Technical grit required:** You won't find a 24/7 call center here. If your server goes down on a Saturday night, it's on you and the community forums.
