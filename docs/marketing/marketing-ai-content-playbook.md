# ChurchCRM Marketing & AI Content Playbook
...
> **Marketing should make people want ChurchCRM before they know all of its features.**

Start with the church's problem, workflow, or desired outcome. Use product features as proof, not as the opening argument.
...
| Pillar | Purpose |
|---|---|
| Church problems | Reach people before they know the product |
| Workflow stories | Show how ChurchCRM fits ministry work |
| Product education | Explain current capabilities |
| Customer stories | Build trust through real experience |
| Open source | Make ownership tangible |
| International/localization | Reach underserved churches globally |
| Tips/how-to | Provide value before conversion |
| Behind the scenes | Humanize the project |
| Community/contributors | Recruit participation |
...
What the current supported ChurchCRM release actually provides.
...
Never market a vision item as an existing feature.
...
1. human/church problem or outcome
2. real product evidence
3. simple brand treatment
4. concise CTA

The automated Playwright Visual Media Pipeline is the preferred source for current product visuals.
...
If an agent has to choose between a more exciting claim and a more accurate claim, choose the accurate claim.
